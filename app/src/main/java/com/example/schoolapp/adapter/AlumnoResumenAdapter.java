...
public class AlumnoResumenAdapter extends RecyclerView.Adapter<AlumnoResumenAdapter.ViewHolder> {
    ...
    private final Map<Integer, ConteoAsistencias> mapaConteo;
    private final Map<Integer, PorcentajeAsistencias> mapaDistribucionPorcentual;
    ...
    public AlumnoResumenAdapter(List<Alumno> alumnos,
                                ...
                                Map<Integer, ConteoAsistencias> mapaConteo,
                                Map<Integer, PorcentajeAsistencias> mapaDistribucionPorcentual){
        this.alumnos = alumnos;
        this.mapaPorcentajes = mapaPorcentajes;
        this.mapaFaltas = mapaFaltas;
        this.mapaDistribucionPorcentual = mapaDistribucionPorcentual;
        this.mapaConteo = mapaConteo;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ConteoAsistencias conteo = mapaConteo.getOrDefault(idAlumno, new ConteoAsistencias(0, 0, 0, 0));
        PorcentajeAsistencias porcentajes = mapaDistribucionPorcentual.getOrDefault(idAlumno, new PorcentajeAsistencias(0, 0, 0, 0));

        configurarBarChart(holder.barChart, conteo);
